...
<section class="probootstrap-cover relative" id="page-header">
  <div class="container">
    <div class="row align-items-center text-center">
      <div class="col-md-12">
        <h2 class="mb-2 probootstrap-animate">We search top airline and travel sites to get you the best deals.</h2>
        <h3 class="mb-5 probootstrap-animate">Search and compare flights</h3>
        <script charset="utf-8" src="//www.travelpayouts.com/widgets/70d87b6b6129e9ad4befe1f25fe3e949.js?v=1400" async>
        </script>
