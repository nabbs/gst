...
@section('title', "{$post->title} - GoSearchTravel.com  | GST")
@section ('content')
		...
		<div class="row mt-lg-5">
			...
			<div class="col-lg-8">
				...
				<div class="row mb-2">
					...
					<div class="col-md-6"><p> <span>{{$post->created_at->toFormattedDateString()}} </span> {{-- <br><br><span>by {{ $post->author}}</span> --}} {{-- <br> <span>{{$d7}} {{$d14}}</span> --}}</div>
