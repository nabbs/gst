	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-4 thm-padding">
				<div class="destination-grid"> <a href="#" class="probootstrap-thumbnail"><img src="{{ $place->image }}" alt="" alt="{{ $place->city }}" class="img-fluid"></a>
				<div class="mask">
					<h2>{{ $place->country }}</h2>
					<p>{{ $place->description }}</p>
					<a href="#" class="thm-btn">Read More</a> </div>
					<div class="dest-name">
						<h5>{{ $place->city }}</h5>
						<h4>{{ $place->country }}</h4>
					</div>
