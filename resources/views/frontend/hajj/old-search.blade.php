...
<section class="probootstrap_section" id="hajj-results">
  ...
  <div class="container">
    ...
    <div class="card-deck isotopeContainer">
      ...
      <div class="col-md-4 mb-5 item isotopeSelector @if($item->price > '6000')pricemore6000 @elseif ($item->price < '6000') priceless6000 @endif @if($item->mk_rating =='5') mk5star @endif @if ($item->md_rating =='5') md5star @endif">

        <div class="card probootstrap-animate">
          <div class="card-img-top">
            <a href="{{$item->package_url}}"> 
              @if ($item->mk_hotel_image =="")
            ...
            <div class="img-layer">
              ...
              <p class="showtooltip" title="Quad: £{{$item->mk_rm_quad_price}}, Triple: £{{$item->mk_rm_triple_price}}, Double £{{$item->mk_rm_double_price}}"> <em>from</em> <strong>&pound;{{ $item->price }}pp</strong> <i class="fa fa-info"></i></p>
          ...
          <div class="card-footer">
            <p>
              <i class="fa fa-bed showtooltip" title="{{$item->md_rm_basis}}"></i>
